...
def worker(
    ...
    while True:
        ...
        view_path = os.path.join('/home/yuxuan/.objaverse/hf-objaverse-v1/views_whole_sphere', item.split('/')[-1][:-4])
        ...
        command = (
            ...
            f" /home/yuxuan/Downloads/blender-3.6.0-linux-x64/blender -b -P scripts/blender_script.py --"
            f" --object_path {item}"
        )
        print(command)
...
if __name__ == "__main__":
    ...
    for item in model_keys:
        queue.put(os.path.join('/home/yuxuan/.objaverse/hf-objaverse-v1', model_paths[item]))
